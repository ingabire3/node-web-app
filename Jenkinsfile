pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'josiane3/node-web-app'
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                ...
                bat '''
                if not exist ".git" (
                    git clone https://github.com/ingabire3/node-web-app.git .
                ) else (
        ...
        stage('Deploy to Local Docker Host') {
            steps {
                ...
                bat """
                    docker stop node-web-app || echo "Container not running..."
                    docker rm -f node-web-app || echo "No container to remove..."
